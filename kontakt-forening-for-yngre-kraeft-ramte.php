...
<head>
    <meta charset="UTF-8">
    <title>Kontakt Forening for Yngre Kræft Ramte</title>
    <meta name="description" content="Spørgsmål om kræft / cancer? Kom i kontakt med Foreningen for Yngre Kræft Ramte">
    ...
    <meta property="og:title" content="Kontakt Forening for Yngre Kræft Ramte" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="http://www.kjproductions.dk/yklf/kontakt-forening-for-yngre-kraeft-ramte.php" />
    <meta property="og:image" content="http://www.kjproductions.dk/yklf/images/logo/logo-02.png" />
    <meta property="og:description" content="Spørgsmål om kræft / cancer? Kom i kontakt med Foreningen for Yngre Kræft Ramte" />
...
<main class="mainKontakt">
    ...
    <section class="sideTitel">
        <h1 class="maksBredde">Kontakt</h1>
    </section>
    <!--KONTAKT FORMULAR-->
    <section class="kontaktFormular maksBredde">
        ...
        <div class="kontaktFormularWrapper">
            ...
            <div class="kontaktFormularImg">
                <img src="images/sidebilleder/forening-for-yngre-kraeft-ramte-til-stafet-for-livet.jpg" alt="morten portræt">
            </div>
        </div>
    </section>
    <!--MØD BESTYRELSEN-->
    <section class="kontaktModBestyrelsen">
        <div class="maksBredde">
            <h1>Vores bestyrelse</h1>
            <div class="kontaktModBestyrelsenFlex">
                <div class="kontaktModBestyrelsenPerson">
                    <img src="images/portraetter/jeanne-formand-forening.jpg" alt="portræt Netværk for yngre kræftramte">
                    <h3>Jeanne Olsen</h3>
                ...
                <div class="kontaktModBestyrelsenPerson">
                    <img src="images/portraetter/morten-forening-for-yngre-kraeft-ramte.jpg" alt="portræt Netværk for yngre kræftramte">
                    <h3>Jeanne Olsen</h3>
                ...
                <div class="kontaktModBestyrelsenPerson">
                    <img src="images/portraetter/tina-medlem-med-cancer.jpg" alt="portræt Netværk for yngre kræftramte">
                    <h3>Stine Hansen</h3>
